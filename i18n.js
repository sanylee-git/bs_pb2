...
const LANG_DATA = {
  ...
  ko: {
    ...
    'guide.faq.a3': '네, iOS Safari와 Android Chrome에서 이용 가능합니다. \'이미지 업로드\' 탭을 이용하면 갤러리 사진을 업로드하거나 카메라로 바로 촬영할 수 있습니다.',
    ...
    'guide.faq.q6': 'Q. 분석에 얼마나 걸리나요?',
    'guide.faq.a6-html': '이미지 분석 자체는 <strong>1~3초</strong> 내에 완료됩니다. 첫 접속 시 AI 모델 파일(약 5~15MB)을 브라우저에 로드하는 데 5~15초가 소요될 수 있습니다. 모델 로드 후에는 즉각 분석이 이루어집니다.',
    'guide.faq.q7': 'Q. 이 서비스는 무료인가요?',
    'guide.faq.a7-html': '네, <strong>완전 무료 서비스</strong>입니다. 회원 가입·로그인·결제가 일절 필요 없습니다. Google AdSense 광고 수익으로 운영되며, 모든 AI 분석 기능은 제한 없이 무료로 제공됩니다.',
    'guide.faq.q8': 'Q. 귀멸의 칼날 상현 중 가장 강한 캐릭터는 누구인가요?',
    'guide.faq.a8-html': '상현 중 가장 강한 캐릭터는 <strong>코쿠시보(상현 壱)</strong>입니다. 귀신들의 왕 무잔을 제외한 귀신 중 최강으로, 달의 호흡과 여섯 개의 눈, 온몸의 칼날이 특징입니다. 귀살대 기둥 3명이 합력해도 쉽게 제압하기 어렵습니다.',
    'guide.faq.q9': 'Q. 어떤 사진이 더 정확한 결과를 주나요?',
    'guide.faq.a9-html': '<strong>정면을 바라본 얼굴 사진</strong>이 가장 정확합니다. 밝은 조명에서 촬영하고 얼굴이 화면의 60~70%를 차지하는 구도를 권장합니다. 선글라스·마스크 착용 사진은 정확도가 낮아질 수 있습니다.',
    'guide.faq.q10': 'Q. 개인 얼굴 데이터가 외부로 유출될 위험이 있나요?',
    'guide.faq.a10-html': '유출 위험이 <strong>전혀 없습니다</strong>. TensorFlow.js를 통해 모든 AI 추론이 사용자의 브라우저 내에서만 처리되므로 이미지 데이터가 어떤 서버에도 전송되지 않습니다. 분석 완료 즉시 데이터가 자동으로 삭제됩니다.',

    /* ── about.html FAQ ── */
    'about.faq.h2': '❓ 자주 묻는 질문 (Q&A)',
    'about.faq.q1': 'Q. 이 서비스는 어떻게 작동하나요?',
    'about.faq.a1': '웹캠 또는 이미지를 업로드하면, 브라우저 내 TensorFlow.js 기반 AI 모델이 얼굴 특징을 분석합니다. 결과는 귀멸의 칼날 상현 캐릭터(코쿠시보·도우마·아카자·한텐구·교코·규타로·다키)와의 유사도 퍼센트로 즉시 표시됩니다. 서버 전송 없이 모든 처리가 기기 내에서 완결됩니다.',
    'about.faq.q2': 'Q. 이 서비스는 왜 개인정보가 안전한가요?',
    'about.faq.a2': '모든 이미지 처리가 사용자의 브라우저에서만 완결되기 때문입니다. TensorFlow.js를 이용한 클라이언트-사이드 AI 추론 방식으로, 얼굴 데이터는 어떤 외부 서버에도 전송되지 않습니다. 분석 완료 즉시 메모리에서 삭제되며, 추가 저장은 일절 없습니다.',
    'about.faq.q3': 'Q. AI 모델은 어떻게 학습되었나요?',
    'about.faq.a3-html': '구글의 <strong>Teachable Machine</strong> 플랫폼으로 귀멸의 칼날 상현 캐릭터 이미지를 학습시킨 딥러닝 이미지 분류 모델입니다. 코쿠시보·도우마·아카자·한텐구·교코·규타로·다키 각 캐릭터별 이미지 데이터를 수집해 얼굴 특징 기반 분류 모델을 훈련했습니다. 모델은 Teachable Machine 공개 인프라에서 호스팅됩니다.',
    'about.faq.q4': 'Q. 어떤 기기와 브라우저에서 사용할 수 있나요?',
    'about.faq.a4-html': 'PC(Windows/Mac)와 모바일(iOS/Android) <strong>모두에서 이용 가능</strong>합니다. Chrome, Safari, Firefox, Edge 최신 버전을 지원합니다. 카메라 기능은 HTTPS 환경에서만 동작하며, 이미지 업로드 기능은 모든 환경에서 사용 가능합니다.',
    'about.faq.q5': 'Q. 이 서비스는 공식 귀멸의 칼날 제품인가요?',
    'about.faq.a5-html': '<strong>비공식 팬 제작 엔터테인먼트 서비스</strong>입니다. 귀멸의 칼날(鬼滅の刃)의 모든 저작권은 원작자 吾峠呼世晴 및 集英社에 귀속됩니다. 본 서비스는 공식 제작사·배급사와 무관하며, 팬이 만든 비상업적 엔터테인먼트 콘텐츠입니다.',
    ...
    'contact.faq.a5-html': '보통 <strong>1~3 영업일</strong> 내로 답변 드립니다. 문의량에 따라 차이가 있을 수 있으나, 접수된 모든 문의에 성실히 답변하겠습니다. 빠른 확인을 위해 문의 유형을 정확히 선택해 주시면 도움이 됩니다.',
    'contact.faq.q6': 'Q. 저작권 관련 문의는 어떻게 하나요?',
    'contact.faq.a6-html': '문의 양식에서 <strong>\'저작권 관련\'</strong>을 선택하고 내용을 기재해 주세요. 귀멸의 칼날 캐릭터 이미지·콘텐츠 관련 저작권 문제를 발견하셨다면 즉시 처리하겠습니다. 공식 저작권자(吾峠呼世晴/集英社) 측의 요청은 최우선으로 처리됩니다.',

    /* ── privacy.html FAQ ── */
    'privacy.faq.h2': '❓ 개인정보 관련 자주 묻는 질문',
    'privacy.faq.q1': 'Q. 카메라로 촬영한 데이터가 서버에 저장되나요?',
    'privacy.faq.a1-html': '아닙니다. 카메라 데이터는 서버에 <strong>전혀 저장되지 않습니다</strong>. 모든 이미지 처리는 사용자의 브라우저 내에서만 이루어지며, AI 분석 완료 즉시 메모리에서 삭제됩니다. 외부 서버 전송 없이 100% 로컬 처리됩니다.',
    'privacy.faq.q2': 'Q. 쿠키를 차단하면 서비스를 이용할 수 없나요?',
    'privacy.faq.a2-html': 'AI 분석 핵심 기능은 <strong>쿠키 없이도 정상 이용 가능</strong>합니다. 쿠키를 차단하면 Google AdSense 맞춤 광고가 표시되지 않고, Disqus 댓글 기능이 제한될 수 있습니다. 기본 기능에는 영향이 없습니다.',
    'privacy.faq.q3': 'Q. Google AdSense 맞춤 광고를 거부할 수 있나요?',
    'privacy.faq.a3-html': '네, <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener">Google 광고 설정</a>에서 맞춤 광고를 <strong>언제든지 비활성화</strong>할 수 있습니다. <a href="https://optout.networkadvertising.org/" target="_blank" rel="noopener">NAI 옵트아웃 페이지</a>에서도 제3자 광고 쿠키를 일괄 차단할 수 있습니다.',
    'privacy.faq.q4': 'Q. 만 14세 미만 어린이도 이용 가능한가요?',
    'privacy.faq.a4-html': '만 14세 미만 이용자는 <strong>반드시 보호자의 동의</strong> 하에 서비스를 이용해야 합니다. 본 서비스는 아동의 개인정보를 의도적으로 수집하지 않으며, 해당 사실이 확인될 경우 즉시 삭제 조치합니다.',
    'privacy.faq.q5': 'Q. 개인정보 열람·수정·삭제를 요청할 수 있나요?',
    'privacy.faq.a5-html': '네, <a href="/contact.html">문의 페이지</a>를 통해 <strong>개인정보 관련 요청</strong>을 하실 수 있습니다. 카메라·이미지 데이터는 분석 즉시 자동 삭제되어 별도 보관되지 않습니다. 문의 양식 제출 시 수집된 이메일 등 정보는 요청 시 삭제해 드립니다.',
  },
  ...
  en: {
    ...
    'guide.faq.q6': 'Q. How long does analysis take?',
    'guide.faq.a6-html': 'The image analysis itself completes within <strong>1–3 seconds</strong>. On first visit, loading the AI model file (about 5–15 MB) may take 5–15 seconds. After the model loads, analysis is instantaneous.',
    'guide.faq.q7': 'Q. Is this service free?',
    'guide.faq.a7-html': 'Yes, it is <strong>completely free</strong>. No sign-up, login, or payment required. The service is funded by Google AdSense ads, and all AI analysis features are available without limitations.',
    'guide.faq.q8': 'Q. Who is the strongest Upper Moon character?',
    'guide.faq.a8-html': 'The strongest Upper Moon is <strong>Kokushibo (Upper Moon 壱)</strong>. He is the most powerful demon after Muzan, characterized by Moon Breathing, six eyes, and blades covering his body. Even three Pillars combined struggle to subdue him.',
    'guide.faq.q9': 'Q. What kind of photo gives the most accurate results?',
    'guide.faq.a9-html': 'A <strong>front-facing photo</strong> works best. Take photos in good lighting with your face filling 60–70% of the frame. Accuracy may decrease with sunglasses, masks, or other face coverings.',
    'guide.faq.q10': 'Q. Is there any risk my facial data will be leaked?',
    'guide.faq.a10-html': 'There is <strong>absolutely no risk of data leakage</strong>. All AI inference via TensorFlow.js runs exclusively within your browser, so image data is never sent to any server. Data is automatically deleted immediately after analysis.',

    /* ── about.html FAQ ── */
    'about.faq.h2': '❓ Frequently Asked Questions (Q&A)',
    'about.faq.q1': 'Q. How does this service work?',
    'about.faq.a1': 'Upload a webcam shot or image, and the TensorFlow.js-based AI model in your browser analyzes facial features. Results instantly show similarity percentages with Demon Slayer Upper Moon characters (Kokushibo, Douma, Akaza, Hantengu, Gyokko, Gyutaro, Daki). All processing is completed on your device with no server transmission.',
    'about.faq.q2': 'Q. Why is my privacy safe with this service?',
    'about.faq.a2': 'All image processing happens exclusively within your browser. Using client-side AI inference via TensorFlow.js, facial data is never transmitted to any external server. Data is deleted from memory immediately after analysis — no additional storage whatsoever.',
    'about.faq.q3': 'Q. How was the AI model trained?',
    'about.faq.a3-html': 'A deep learning image classification model trained on Demon Slayer Upper Moon character images using Google\'s <strong>Teachable Machine</strong> platform. Image data was collected for each character (Kokushibo, Douma, Akaza, Hantengu, Gyokko, Gyutaro, Daki) to train a face-feature-based classification model. The model is hosted on Teachable Machine\'s public infrastructure.',
    'about.faq.q4': 'Q. What devices and browsers are supported?',
    'about.faq.a4-html': '<strong>Available on both PC (Windows/Mac) and mobile (iOS/Android)</strong>. Supports the latest versions of Chrome, Safari, Firefox, and Edge. Camera functionality requires HTTPS, while the image upload feature works in all environments.',
    'about.faq.q5': 'Q. Is this an official Demon Slayer product?',
    'about.faq.a5-html': 'No, this is an <strong>unofficial fan-made entertainment service</strong>. All rights to Demon Slayer (鬼滅の刃) belong to the original creator 吾峠呼世晴 and 集英社. This service is unrelated to any official production or distribution company — it is non-commercial fan-made content.',
    ...
    'contact.faq.q5': 'Q. How long does it take to get a reply?',
    'contact.faq.a5-html': 'Usually within <strong>1–3 business days</strong>. It may vary based on inquiry volume, but we reply to all inquiries sincerely. Selecting the correct inquiry type helps us respond faster.',
    'contact.faq.q6': 'Q. How do I submit a copyright-related inquiry?',
    'contact.faq.a6-html': 'Select <strong>"Copyright Related"</strong> in the inquiry form and describe the issue. If you\'ve found a copyright issue with Demon Slayer character images or content, we\'ll address it immediately. Requests from official rights holders (吾峠呼世晴/集英社) are handled with top priority.',

    /* ── privacy.html FAQ ── */
    'privacy.faq.h2': '❓ Privacy-Related FAQ',
    'privacy.faq.q1': 'Q. Is camera data stored on your servers?',
    'privacy.faq.a1-html': 'No. Camera data is <strong>never stored on any server</strong>. All image processing happens solely within your browser, and data is deleted from memory immediately after AI analysis. 100% local processing — no external server transmission.',
    'privacy.faq.q2': 'Q. Can I still use the service if I block cookies?',
    'privacy.faq.a2-html': 'The core AI analysis feature <strong>works without cookies</strong>. Blocking cookies will only prevent personalized Google AdSense ads and may limit Disqus comments. Core functionality is not affected.',
    'privacy.faq.q3': 'Q. Can I opt out of personalized Google AdSense ads?',
    'privacy.faq.a3-html': 'Yes, you can <strong>disable personalized ads anytime</strong> at <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener">Google Ad Settings</a>. You can also block all third-party ad cookies at the <a href="https://optout.networkadvertising.org/" target="_blank" rel="noopener">NAI opt-out page</a>.',
    'privacy.faq.q4': 'Q. Can children under 14 use this service?',
    'privacy.faq.a4-html': 'Users under 14 must use this service <strong>only with parental consent</strong>. We do not intentionally collect personal information from children, and will delete any such data immediately upon becoming aware of it.',
    'privacy.faq.q5': 'Q. Can I request to view, edit, or delete my personal data?',
    'privacy.faq.a5-html': 'Yes, you can submit <strong>personal data-related requests</strong> via the <a href="/contact.html">Contact page</a>. Camera and image data is automatically deleted immediately after analysis — no separate storage exists. Email and other information submitted via contact forms can be deleted upon request.',
  }
};
